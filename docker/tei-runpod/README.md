...
docker buildx build --platform linux/amd64 \
    -t ghcr.io/rkrug/tei-specter2:proximity-v0.1.0 \
...
docker buildx build --platform linux/amd64 \
    -t ghcr.io/rkrug/tei-specter2:adhoc_query-v0.1.0 \
    --build-arg ADAPTER=adhoc_query \
    --build-arg TEI_TAG=89-1.5 \
    -f docker/tei-runpod/Dockerfile .

docker push ghcr.io/rkrug/tei-specter2:proximity-v0.1.0
docker push ghcr.io/rkrug/tei-specter2:adhoc_query-v0.1.0
```
...
- **Immutable digest** (`@sha256:abc123…`) — strongest reproducibility
  ...
  docker inspect --format='{{index .RepoDigests 0}}' \
      ghcr.io/rkrug/tei-specter2:proximity-v0.1.0
  ```
...
```bash
docker tag  ghcr.io/rkrug/tei-specter2:proximity-v0.1.0 \
            ghcr.io/rkrug/tei-specter2:proximity-v0.2.0
docker push ghcr.io/rkrug/tei-specter2:proximity-v0.2.0
```
...
2. RunPod → **GPU Pod** → "Edit Template".
   - Container Image: `ghcr.io/rkrug/tei-specter2:proximity-v0.1.0` (or the immutable `@sha256:…` digest — see "Tagging strategy")
