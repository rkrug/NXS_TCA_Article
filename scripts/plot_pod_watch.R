#!/usr/bin/env Rscript
# Plot pod_watch.sh log as a 4-panel time series: pod_mem%, cpu%, rss GB,
# gpu_mem GB.
#
# Usage:
#   Rscript scripts/plot_pod_watch.R                       # plot most recent, once
#   Rscript scripts/plot_pod_watch.R path/to/log.log       # plot a specific file
#   Rscript scripts/plot_pod_watch.R --watch               # re-render every 30s
#   Rscript scripts/plot_pod_watch.R --watch --interval 10 # custom interval (s)
#
